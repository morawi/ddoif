...
## DDOIF Manual 
The manual conains important information about the DDOIF file structure and API usage. It demonstrates the functions that can be used to handle a ".ddof" file. See Manual folder for details 
![Manual](https://github.com/morawi/ddoif/blob/master/Manual/)
